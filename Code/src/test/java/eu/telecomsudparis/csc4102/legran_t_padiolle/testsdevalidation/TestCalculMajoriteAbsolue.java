...
import eu.telecomsudparis.csc4102.legran_t_padiolle.CalculMajoriteAbsolue;
...
public class TestCalculMajoriteAbsolue {
	...
	public void setUp() throws Exception {
		...
		strategieDeCalculVote = new CalculMajoriteAbsolue();
		...
		questionVotable.ajouterVoteCoproprietaire(coproprietaire2, Evote.NON);
	...
	@Test
	public void testCtr() {
		Assert.assertEquals(questionVotable.getNombreOui(), 400);
		Assert.assertEquals(questionVotable.getNombreNon(), 200);
